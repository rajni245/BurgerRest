...
function Typesburger() {
  const playStoreUrl = "https://play.google.com/store/apps/details?id=com.example.app"; // Replace with your app's Play Store URL
  ...
  return (
    <div className="container-fluid  ">
      <div className="row no-gutters">
        ...
        <div className=" text-center col-12 col-md-6 d-flex align-items-stretch position-relative p-0">
          <img
            src="burger2.jpg"
